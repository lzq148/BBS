        ...
        <div class="right-section">
            ...
            <div class="search-container">
                <form method="get" action="search.php" class="search-form">
                    <input type="text" name="keyword" class="search-input" placeholder="搜索文章..." required>
...
<div class="container">
    ...
    $article_info = $conn->query($sql);
    ?>

    <!-- 帖子列表 -->
    <?php if($article_info && $article_info->num_rows > 0): ?>
        <?php while($row = $article_info->fetch_assoc()): ?>
            <div class="article">
